...
Heading=tkinter.Label(r,text="TO DO LIST",fg="white",bg="purple",font=("Arial",20,"italic","bold"),pady=15)
Heading.pack()
...
f2=tkinter.Frame(r,bg="purple")
f2.pack()

inputvar=tkinter.StringVar()                                                                                 # string variable for input
inputlabel=tkinter.Label(f2,text="Input Task",bg="purple",fg="white",font=("Ariel",13),padx=10)       # Label widget
...
button.bind("<Button-1>",click)
#B
button=tkinter.Button(f3,text="QUIT",width=20,fg="white",bg="black",padx=10,command=quit)                     # quit button to close the program
